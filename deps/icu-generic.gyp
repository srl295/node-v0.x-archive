          ...
          'actions': [
            {
              ...
              'action': [ 'icu-trim/icutrim.py -P ../<(CONFIGURATION_NAME) -D <(icu_data_in) --delete-tmp -T ../out/icutmp -F icu-trim/icu_small.json -O icudt<(icu_ver_major)<(icu_endianness).dat -v' ],
            },
            {
              # build final .dat -> .obj
