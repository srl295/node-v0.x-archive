...
then
    UFLAGS="UCONFIG_NO_LEGACY_CONVERSION=1 UCONFIG_NO_IDNA=1 UCONFIG_NO_BREAK_ITERATION=0 UCONFIG_NO_TRANSLITERATION=1 UCONFIG_NO_REGULAR_EXPRESSIONS=1 UCONFIG_SRL_NO_TEST_API=1 UDATA_SRL_DISK_FIRST=1"
else
    UFLAGS=""
fi
